...
function renderLadderTypesView(root, rows, source) {
  ...
  return el("div", { class: "stack" }, [
    el("div", { class: "row-between wrap" }, [
      ...
      el("div", { class: "toolbar" }, [
        el("button", { type: "button", class: "btn btn-secondary btn-sm", onClick: () => { working.push({ name: "", template: "", secondary_template: "" }); update(); } }, ["+ Add Ladder Type"]),
        el("button", { type: "button", class: "btn btn-primary btn-sm", onClick: (event) => save(event.target) }, ["\uD83D\DCBE Save Ladder Types"]),
      ]),
    ]),
    el("div", { class: "table-wrap" }, [
      el("table", { class: "data-table" }, [
        el("thead", {}, [el("tr", {}, [el("th", { text: "Ladder Type" }), el("th", { text: "Primary Template" }), el("th", { text: "Secondary Template" }), el("th", { text: "" })])]),
        el("tbody", {}, working.map((row, index) => el("tr", {}, [
          ...
          el("td", {}, [el("button", { type: "button", class: "btn btn-danger btn-sm", onClick: () => { working.splice(index, 1); update(); } }, ["Delete"])]),
        ]))),
      ]),
    ]),
  ]);
