...
TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "templates"
TEMPLATES_DIR.mkdir(exist_ok=True)

CTRL_TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "controller"
CTRL_TEMPLATES_DIR.mkdir(exist_ok=True)

IO_TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "io"
IO_TEMPLATES_DIR.mkdir(exist_ok=True)

LADDER_TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "ladder"
LADDER_TEMPLATES_DIR.mkdir(exist_ok=True)

LADDER_COMPONENT_TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "ladder_components"
LADDER_COMPONENT_TEMPLATES_DIR.mkdir(exist_ok=True)

VALVES_TEMPLATES_DIR = _PROJECT_ROOT / "templates" / "valves"
