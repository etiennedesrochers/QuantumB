...
from src.core.drawing_generator import Rung, Component
from src.symbols.electrical_symbols import SYMBOL_REGISTRY
...
from src.core.io_manager import IO_TYPES, IO_FIELDS
from .i18n import tr
from src.core.models import Circuit
...
def _load_ladder_types() -> list[str]:
    ...
    try:
        ladder_types_file = Path(__file__).resolve().parent.parent.parent / "config" / "ladder_types.json"
...
def _load_ladder_component_templates() -> list[str]:
    ...
    try:
        components_dir = Path(__file__).resolve().parent.parent.parent / "templates" / "ladder_components"
